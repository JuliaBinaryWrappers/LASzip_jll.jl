...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LASzip_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("8372b9c3-1e34-5cc3-bfab-1a98e101de11"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LASzip", artifacts_toml) for e in artifacts["LASzip"]]
...
if best_platform === nothing
    @debug("Unable to load LASzip; unsupported platform $(triplet(platform_key_abi()))")
else
